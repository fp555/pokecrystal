...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLE_ANIM_FRAMESET_SONICBOOM_JP          ; 49
	const BATTLE_ANIM_FRAMESET_WARP                  ; 4a
	const BATTLE_ANIM_FRAMESET_CHARGE_ORB_2          ; 4b
	const BATTLE_ANIM_FRAMESET_EGG                   ; 4c
	const BATTLE_ANIM_FRAMESET_EGG_WOBBLE            ; 4d
	const BATTLE_ANIM_FRAMESET_EGG_CRACKED_TOP       ; 4e
	const BATTLE_ANIM_FRAMESET_EGG_CRACKED_BOTTOM    ; 4f
	const BATTLE_ANIM_FRAMESET_FOCUS                 ; 50
	const BATTLE_ANIM_FRAMESET_BIND_1                ; 51
	const BATTLE_ANIM_FRAMESET_BIND_2                ; 52
	const BATTLE_ANIM_FRAMESET_BIND_3                ; 53
	const BATTLE_ANIM_FRAMESET_BIND_4                ; 54
	const BATTLE_ANIM_FRAMESET_LEECH_SEED_1          ; 55
	const BATTLE_ANIM_FRAMESET_LEECH_SEED_2          ; 56
	const BATTLE_ANIM_FRAMESET_LEECH_SEED_3          ; 57
	const BATTLE_ANIM_FRAMESET_SOUND_1               ; 58
	const BATTLE_ANIM_FRAMESET_SOUND_2               ; 59
	const BATTLE_ANIM_FRAMESET_SOUND_3               ; 5a
	const BATTLE_ANIM_FRAMESET_WAVE                  ; 5b
	const BATTLE_ANIM_FRAMESET_CONFUSE_RAY_1         ; 5c
	const BATTLE_ANIM_FRAMESET_CONFUSE_RAY_2         ; 5d
	const BATTLE_ANIM_FRAMESET_LEER                  ; 5e
	const BATTLE_ANIM_FRAMESET_REFLECT               ; 5f
	const BATTLE_ANIM_FRAMESET_CHICK_1               ; 60
	const BATTLE_ANIM_FRAMESET_CHICK_2               ; 61
	const BATTLE_ANIM_FRAMESET_AMNESIA_1             ; 62
	const BATTLE_ANIM_FRAMESET_AMNESIA_2             ; 63
	const BATTLE_ANIM_FRAMESET_AMNESIA_3             ; 64
	const BATTLE_ANIM_FRAMESET_ASLEEP                ; 65
	const BATTLE_ANIM_FRAMESET_DIG_SAND              ; 66
	const BATTLE_ANIM_FRAMESET_DIG_PILE              ; 67
	const BATTLE_ANIM_FRAMESET_SAND                  ; 68
	const BATTLE_ANIM_FRAMESET_STRING_SHOT_1         ; 69
	const BATTLE_ANIM_FRAMESET_STRING_SHOT_2         ; 6a
	const BATTLE_ANIM_FRAMESET_STRING_SHOT_3         ; 6b
	const BATTLE_ANIM_FRAMESET_PARALYZED             ; 6c
	const BATTLE_ANIM_FRAMESET_PARALYZED_FLIPPED     ; 6d
	const BATTLE_ANIM_FRAMESET_HAZE                  ; 6e
	const BATTLE_ANIM_FRAMESET_MIST                  ; 6f
	const BATTLE_ANIM_FRAMESET_HORN                  ; 70
	const BATTLE_ANIM_FRAMESET_NEEDLE                ; 71
	const BATTLE_ANIM_FRAMESET_FLOWER                ; 72
	const BATTLE_ANIM_FRAMESET_BARRAGE_BALL          ; 73
	const BATTLE_ANIM_FRAMESET_PAY_DAY               ; 74
	const BATTLE_ANIM_FRAMESET_HEART                 ; 75
	const BATTLE_ANIM_FRAMESET_SPINNING_BONE         ; 76
	const BATTLE_ANIM_FRAMESET_STAR                  ; 77
	const BATTLE_ANIM_FRAMESET_SPOON                 ; 78
	const BATTLE_ANIM_FRAMESET_SPARKLE               ; 79
	const BATTLE_ANIM_FRAMESET_SKY_ATTACK            ; 7a
	const BATTLE_ANIM_FRAMESET_LICK                  ; 7b
	const BATTLE_ANIM_FRAMESET_WITHDRAW_SHELL        ; 7c
	const BATTLE_ANIM_FRAMESET_SHRINKING_CHARGE_ORB  ; 7d
	const BATTLE_ANIM_FRAMESET_CONVERSION            ; 7e
	const BATTLE_ANIM_FRAMESET_SWORD                 ; 7f
	const BATTLE_ANIM_FRAMESET_SPEED_LINE_1          ; 80
	const BATTLE_ANIM_FRAMESET_SPEED_LINE_2          ; 81
	const BATTLE_ANIM_FRAMESET_SPEED_LINE_3          ; 82
	const BATTLE_ANIM_FRAMESET_SEISMIC_TOSS          ; 83
	const BATTLE_ANIM_FRAMESET_SHARPEN               ; 84
	const BATTLE_ANIM_FRAMESET_DEFENSE_CURL          ; 85
	const BATTLE_ANIM_FRAMESET_METRONOME_HAND        ; 86
	const BATTLE_ANIM_FRAMESET_AGILITY               ; 87
	const BATTLE_ANIM_FRAMESET_COTTON                ; 88
	const BATTLE_ANIM_FRAMESET_MILK_BOTTLE           ; 89
	const BATTLE_ANIM_FRAMESET_SPIKE                 ; 8a
	const BATTLE_ANIM_FRAMESET_ANGER_VEIN            ; 8b
	const BATTLE_ANIM_FRAMESET_HEAL_BELL             ; 8c
	const BATTLE_ANIM_FRAMESET_BATON_PASS            ; 8d
	const BATTLE_ANIM_FRAMESET_LOCK_ON_1             ; 8e
	const BATTLE_ANIM_FRAMESET_LOCK_ON_2             ; 8f
	const BATTLE_ANIM_FRAMESET_LOCK_ON_3             ; 90
	const BATTLE_ANIM_FRAMESET_LOCK_ON_4             ; 91
	const BATTLE_ANIM_FRAMESET_MIND_READER_1         ; 92
	const BATTLE_ANIM_FRAMESET_MIND_READER_2         ; 93
	const BATTLE_ANIM_FRAMESET_MIND_READER_3         ; 94
	const BATTLE_ANIM_FRAMESET_MIND_READER_4         ; 95
	const BATTLE_ANIM_FRAMESET_SAFEGUARD             ; 96
