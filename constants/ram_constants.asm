...
DEF JUMPTABLE_EXIT_F EQU 7
DEF JUMPTABLE_EXIT EQU 1 << JUMPTABLE_EXIT_F
...
DEF TEXT_DELAY_FAST EQU 1
DEF TEXT_DELAY_MED  EQU 3
DEF TEXT_DELAY_SLOW EQU 5
...
; wStateFlags
	const_def
	const SPRITE_UPDATES_DISABLED_F             ; 0
	const LAST_12_SPRITE_OAM_STRUCTS_RESERVED_F ; 1
	const_skip 4
	const TEXT_STATE_F                          ; 6
	const SCRIPTED_MOVEMENT_STATE_F             ; 7

; wSpriteFlags::
	const_def 5
	const SPRITES_VRAM_BANK_0_F       ; 5
...
DEF ANYTIME EQU MORN | DAY | EVN | NITE
...
DEF DARKNESS_PALSET EQU (MORN_F << 6) | (DAY_F << 4) | (EVN_F << 2) | NITE_F
