...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_N64 ; 51
	const SPRITE_VIRTUAL_BOY ; 52
	const SPRITE_SURF ; 53
	const SPRITE_POKE_BALL ; 54
	const SPRITE_POKEDEX ; 55
	const SPRITE_PAPER ; 56
	const SPRITE_ROCK ; 57
	const SPRITE_BOULDER ; 58
	const SPRITE_SNES ; 59
	const SPRITE_FAMICOM ; 5a
	const SPRITE_FRUIT_TREE ; 5b
	const SPRITE_GOLD_TROPHY ; 5c
