...
; entries correspond to OddEggs (below)
	table_width 2
	odd_egg_prob 15 ; Pichu
	odd_egg_prob 15 ; Cleffa
	odd_egg_prob 15 ; Igglybuff
	odd_egg_prob 15 ; Smoochum
	odd_egg_prob 15 ; Magby
	odd_egg_prob 15 ; Elekid
	odd_egg_prob 10 ; Tyrogue
