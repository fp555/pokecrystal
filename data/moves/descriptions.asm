...
BeatUpDescription:
	db   "Each party #MON"
	next "adds 1 extra hit.@"

FuryCutterDescription:
	db   "Stronger each time"
	next "on successive use.@"
...
MagnitudeDescription:
	db   "Double damage if"
	next "target used DIG.@"

GustDescription:
TwisterDescription:
	db   "Double damage if"
	next "target used FLY.@"

PursuitDescription:
	db   "Double damage if"
	next "target switches.@"

RoarDescription:
WhirlwindDescription:
	db   "Target flees from"
	next "battle.@"
...
FlailDescription:
ReversalDescription:
	db   "Gets stronger the"
	next "less HP user has.@"

HiddenPowerDescription:
	db   "Power/type varies"
	next "with user's DVs.@"

DisableDescription:
	db   "Disables target's"
...
EncoreDescription:
	db   "Target repeats 2-6"
	next "turns last move.@"
...
ConversionDescription:
	db   "Changes user type"
	next "to a move's type.@"

Conversion2Description:
	db   "Changes user type"
	next "to resist target.@"

PayDayDescription:
	db   "Earn extra money"
	next "when battle ends.@"
...
RestDescription:
	db   "Heals user to full"
	next "HP, sleep 2 turns.@"

MoonlightDescription:
MorningSunDescription:
SynthesisDescription:
	db   "Heals user based"
	next "on time/weather.@"
...
LeechSeedDescription:
	db   "Steals HP from"
	next "target every turn.@"

SubstituteDescription:
	db   "Makes a decoy with"
	next "25<%> user's max HP.@"

CurseDescription:
	db   "Uses 25<%> max HP"
	next "to curse target.@"
...
VitalThrowDescription:
	db   "User attacks last"
	next "but never misses.@"
...
SpiteDescription:
	db   "Reduces PP of the"
	next "target last move.@"
