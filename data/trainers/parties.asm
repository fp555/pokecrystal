...
CooltrainerMGroup:
	...
	db 26, SQUIRTLE,   WITHDRAW, WATER_GUN, BITE, RAPID_SPIN
...
CooltrainerFGroup:
	...
	db 32, BLASTOISE,  BITE, BULK_UP, SURF, RAIN_DANCE
	db -1 ; end
...
SuperNerdGroup:
	...
	db 19, SLOWPOKE,   BULK_UP, WATER_GUN, GROWL, STRENGTH
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   PROTECT, SMOG, FLAMETHROWER, ROCK_SLIDE
...
PsychicGroup:
	...
	db 20, SLOWPOKE,   BULK_UP, BODY_SLAM, WATER_GUN, CONFUSION
	db -1 ; end
