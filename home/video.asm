...
; Only call during the first fifth of VBlank
	...
	cp LY_VBLANK + 2
	ret nc
	; Copy [wRequested1bppSize] 1bpp tiles
	; from [wRequested1bppSource] to [wRequested1bppDest]
	ld [hSPBuffer], sp
	; Source
...
_Serve2bppRequest::
; Copy [wRequested2bppSize] 2bpp tiles 
; from [wRequested2bppSource] to [wRequested2bppDest]
	ld [hSPBuffer], sp
	; Source
