...
FuchsiaCity_MapEvents:
	...
	def_warp_events
	warp_event 31, 27, FUCHSIA_MART, 2
	...
	def_bg_events
	bg_event 23, 27, BGEVENT_READ, FuchsiaCitySign
	bg_event  3, 27, BGEVENT_READ, FuchsiaGymSign
	bg_event  7, 17, BGEVENT_READ, SafariZoneOfficeSign
	bg_event 27, 29, BGEVENT_READ, WardensHomeSign
	bg_event 21,  5, BGEVENT_READ, SafariZoneClosedSign
	bg_event 27,  9, BGEVENT_READ, NoLitteringSign
	bg_event 20, 27, BGEVENT_READ, FuchsiaCityPokecenterSign
	bg_event 32, 27, BGEVENT_READ, FuchsiaCityMartSign
	...
	object_event 27,  4, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, FuchsiaCityPokefanM, -1
	object_event 15, 11, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, FuchsiaCityTeacher, -1
	object_event 27, 21, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FuchsiaCityFruitTree, -1
