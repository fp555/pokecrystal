...
GoldenrodGameCornerMemoryGameReceptionistScript:
...
GoldenrodGameCorner_MapEvents:
	...
	def_bg_events
	bg_event  0,  7, BGEVENT_UP, GoldenrodGameCornerMemoryGameScript
	bg_event  1,  7, BGEVENT_UP, GoldenrodGameCornerMemoryGameScript
	bg_event  6,  8, BGEVENT_RIGHT, GoldenrodGameCornerSlotsMachineScript
	bg_event  6,  9, BGEVENT_RIGHT, GoldenrodGameCornerSlotsMachineScript
	bg_event  6, 10, BGEVENT_RIGHT, GoldenrodGameCornerSlotsMachineScript
	bg_event  6, 11, BGEVENT_RIGHT, GoldenrodGameCornerLuckySlotsMachineScript
	bg_event  7,  8, BGEVENT_LEFT, GoldenrodGameCornerLuckySlotsMachineScript
	bg_event  7,  9, BGEVENT_LEFT, GoldenrodGameCornerSlotsMachineScript
	bg_event  7, 10, BGEVENT_LEFT, GoldenrodGameCornerSlotsMachineScript
	bg_event  7, 11, BGEVENT_LEFT, GoldenrodGameCornerSlotsMachineScript
	bg_event 12,  1, BGEVENT_RIGHT, GoldenrodGameCornerLeftTheirDrinkScript
	bg_event 12,  8, BGEVENT_RIGHT, GoldenrodGameCornerSlotsMachineScript
	bg_event 12,  9, BGEVENT_RIGHT, GoldenrodGameCornerLuckySlotsMachineScript
	bg_event 12, 10, BGEVENT_RIGHT, GoldenrodGameCornerSlotsMachineScript
	bg_event 12, 11, BGEVENT_RIGHT, GoldenrodGameCornerSlotsMachineScript
	bg_event 13,  8, BGEVENT_LEFT, GoldenrodGameCornerCardFlipMachineScript
	bg_event 13,  9, BGEVENT_LEFT, GoldenrodGameCornerCardFlipMachineScript
	bg_event 13, 10, BGEVENT_LEFT, GoldenrodGameCornerCardFlipMachineScript
	bg_event 13, 11, BGEVENT_LEFT, GoldenrodGameCornerCardFlipMachineScript
	bg_event 18,  8, BGEVENT_RIGHT, GoldenrodGameCornerCardFlipMachineScript
	bg_event 18,  9, BGEVENT_RIGHT, GoldenrodGameCornerCardFlipMachineScript
	bg_event 18, 10, BGEVENT_RIGHT, GoldenrodGameCornerCardFlipMachineScript
	...
	object_event  8,  9, SPRITE_PHARMACIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, DAY | NITE, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GoldenrodGameCornerPharmacistScript, -1
	...
	object_event 17,  8, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodGameCornerPokefanFScript, -1
	...
	object_event  1,  5, SPRITE_RECEPTIONIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodGameCornerMemoryGameReceptionistScript, -1
